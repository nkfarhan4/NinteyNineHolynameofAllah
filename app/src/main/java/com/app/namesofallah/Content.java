...
public class Content {
    ...
    Content(){
        ...
        this.NamesSub.add(0,"Allah");
        this.NamesSub.add(1,"Ar-Rahmaan");
        this.NamesSub.add(2,"Ar-Raheem");
        this.NamesSub.add(3,"Al-Malik");
        this.NamesSub.add(4,"Al-Quddoos");
        this.NamesSub.add(5,"As-Salaam");
        this.NamesSub.add(6,"Al-Mu'min");
        this.NamesSub.add(7,"Al-Muhaymin");
        this.NamesSub.add(8,"Al-'Azeez");
        this.NamesSub.add(9,"Al-Jabbaar");
        this.NamesSub.add(10,"Al-Mutakabbir");
        this.NamesSub.add(11,"Al-Khaaliq");
        this.NamesSub.add(12,"Al-Baari'");
        this.NamesSub.add(13,"Al-Musawwir");
        this.NamesSub.add(14,"Al-Ghaffaar");
        this.NamesSub.add(15,"Al-Qahhaar");
        this.NamesSub.add(16,"Al-Wahhaab");
        this.NamesSub.add(17,"Ar-Razzaaq");
        this.NamesSub.add(18,"Al-Fattaah");
        this.NamesSub.add(19,"Al-'Aleem");
        this.NamesSub.add(20,"Al-Qaabid");
        this.NamesSub.add(21,"Al-Baasit");
        this.NamesSub.add(22,"Al-Khaafid");
        this.NamesSub.add(23,"Ar-Raafi'");
        this.NamesSub.add(24,"Al-Mu'iz");
        this.NamesSub.add(25,"Al-Baa'ith");
        this.NamesSub.add(26,"Ash-Shaheed");
        this.NamesSub.add(27,"Al-Haqq");
        this.NamesSub.add(28,"Al-Wakeel");
        this.NamesSub.add(29,"Al-Qawiyy");
        this.NamesSub.add(30,"Al-Mateen");
        this.NamesSub.add(31,"Al-Waliyy");
        this.NamesSub.add(32,"Al-Hameed");
        this.NamesSub.add(33,"Al-Muhsee");
        this.NamesSub.add(34,"Al-Mubdi'");
        this.NamesSub.add(35,"Al-Mu'eed");
        this.NamesSub.add(36,"Al-Muhyee");
        this.NamesSub.add(37,"Al-Mumeet");
        this.NamesSub.add(38,"Al-Hayy");
        this.NamesSub.add(39,"Al-Qayyoom");
        this.NamesSub.add(40,"Al-Waajid");
        this.NamesSub.add(41,"Al-Maajid");
        this.NamesSub.add(42,"Al-Waahid");
        this.NamesSub.add(43,"As-Samad");
        this.NamesSub.add(44,"Al-Qaadir");
        this.NamesSub.add(45,"Al-Muqtadir");
        this.NamesSub.add(46,"Al-Muqaddim");
        this.NamesSub.add(47,"Al-Mu'akhkhir");
        this.NamesSub.add(48,"Al-Awwal");
        this.NamesSub.add(49,"Al-Aakhir");
        this.NamesSub.add(50,"Al-Mudhil");
        this.NamesSub.add(51,"As-Sami'");
        this.NamesSub.add(52,"Al-Baseer");
        this.NamesSub.add(53,"Al-Hakam");
        this.NamesSub.add(54,"Al-'Adl");
        this.NamesSub.add(55,"Al-Lateef");
        this.NamesSub.add(56,"Al-Khabeer");
        this.NamesSub.add(57,"Al-Haleem");
        this.NamesSub.add(58,"Al-'Azeem");
        this.NamesSub.add(59,"Al-Ghafoor");
        this.NamesSub.add(60,"Ash-Shakoor");
        this.NamesSub.add(61,"Al-'Aliyy");
        this.NamesSub.add(62,"Al-Kabeer");
        this.NamesSub.add(63,"Al-Hafeez");
        this.NamesSub.add(64,"Al-Muqeet");
        this.NamesSub.add(65,"Al-Haseeb");
        this.NamesSub.add(66,"Al-Jaleel");
        this.NamesSub.add(67,"Al-Kareem");
        this.NamesSub.add(68,"Ar-Raqeeb");
        this.NamesSub.add(69,"Al-Mujeeb");
        this.NamesSub.add(70,"Al-Waasi'");
        this.NamesSub.add(71,"Al-Hakeem");
        this.NamesSub.add(72,"Al-Wadood");
        this.NamesSub.add(73,"Al-Majeed");
        this.NamesSub.add(74,"Az-Zaahir");
        this.NamesSub.add(75,"Al-Baatin");
        this.NamesSub.add(76,"Al-Waalee");
        this.NamesSub.add(77,"Al-Muta'aalee");
        this.NamesSub.add(78,"Al-Barr");
        this.NamesSub.add(79,"At-Tawwaab");
        this.NamesSub.add(80,"Al-Muntaqim");
        this.NamesSub.add(81,"Al-'Afuww");
        this.NamesSub.add(82,"Ar-Ra'oof");
        this.NamesSub.add(83,"Maalik-ul-Mulk");
        this.NamesSub.add(84,"Dhul-Jalaali \n Wal-Ikraam");
        this.NamesSub.add(85,"Al-Muqsit");
        this.NamesSub.add(86,"Al-Jaami'");
        this.NamesSub.add(87,"Al-Ghaniyy");
        this.NamesSub.add(88,"Al-Mughnee");
        this.NamesSub.add(89,"Al-Maani'");
        this.NamesSub.add(90,"Ad-Daar");
        this.NamesSub.add(91,"An-Naafi'");
        this.NamesSub.add(92,"An-Noor");
        this.NamesSub.add(93,"Al-Haadee");
        this.NamesSub.add(94,"Al-Badee'");
        this.NamesSub.add(95,"Al-Baaqee");
        this.NamesSub.add(96,"Al-Waarish");
        this.NamesSub.add(97,"Ar-Rasheed");
        this.NamesSub.add(98,"As-Saboor");

        //main list



        this.Names.add(0,"1. Allah (The Name of Allah)");
        this.Names.add(1,"2. Ar-Rahmaan (The Beneficent)");
        this.Names.add(2,"3. Ar-Raheem (The Most Merciful)");
        this.Names.add(3,"4. Al-Malik (The Eternal Lord)");
        this.Names.add(4,"5. Al-Quddoos (The Most Sacred)");
        this.Names.add(5,"6. As-Salaam (The Embodiment of Peace)");
        this.Names.add(6,"7. Al-Mu'min (The Infuser of Faith)");
        this.Names.add(7,"8. Al-Muhaymin (The Preserver of Safety)");
        this.Names.add(8,"9. Al-'Azeez (The Mighty One)");
        this.Names.add(9,"10. Al-Jabbaar (The Omnipotent One)");
        this.Names.add(10,"11. Al-Mutakabbir (The Dominant One)");
        this.Names.add(11,"12. Al-Khaaliq (The Creator)");
        this.Names.add(12,"13. Al-Baari' (The Evolver)");
        this.Names.add(13,"14. Al-Musawwir (The Flawless Shaper)");
        this.Names.add(14,"15. Al-Ghaffaar (The Great Forgiver)");
        this.Names.add(15,"16. Al-Qahhaar (The All-Prevailing One)");
        this.Names.add(16,"17. Al-Wahhaab (The Supreme Bestower)");
        this.Names.add(17,"18. Ar-Razzaaq (The Total Provider)");
        this.Names.add(18,"19. Al-Fattaah (The Supreme Solver)");
        this.Names.add(19,"20. Al-'Aleem (The All-Knowing)");
        this.Names.add(20,"21. Al-Qaabid (The Restricting One)");
        this.Names.add(21,"22. Al-Baasit (The Extender)");
        this.Names.add(22,"23. Al-Khaafid (The Reducer)");
        this.Names.add(23,"24. Ar-Raafi' (The Elevating One)");
        this.Names.add(24,"25. Al-Mu'iz (The Honourer-Bestower)");
        this.Names.add(25,"26. Al-Baa'ith (The Infuser of New Life)");
        this.Names.add(26,"27. Ash-Shaheed (The All Observing Witness)");
        this.Names.add(27,"28. Al-Haqq (The Embodiment of Truth)");
        this.Names.add(28,"29. Al-Wakeel (The Universal Trustee)");
        this.Names.add(29,"30. Al-Qawiyy (The Strong One)");
        this.Names.add(30,"31. Al-Mateen (The Authoritative)");
        this.Names.add(31,"32. Al-Waliyy (The Patron)");
        this.Names.add(32,"33. Al-Hameed (The Sole-Laudable One)");
        this.Names.add(33,"34. Al-Muhsee (The Reckoner)");
        this.Names.add(34,"35. Al-Mubdi' (The Originator)");
        this.Names.add(35,"36. Al-Mu'eed (The Restorer)");
        this.Names.add(36,"37. Al-Muhyee (The Giver of Life)");
        this.Names.add(37,"38. Al-Mumeet (The Giver of Death)");
        this.Names.add(38,"39. Al-Hayy (The Ever-Living)");
        this.Names.add(39,"40. Al-Qayyoom (The Self-Subsisting Sustainer of All)");
        this.Names.add(40,"41. Al-Waajid (The Finder)");
        this.Names.add(41,"42. Al-Maajid (The Glorious)");
        this.Names.add(42,"43. Al-Waahid (The One)");
        this.Names.add(43,"44. As-Samad (The Eternally Besought)");
        this.Names.add(44,"45. Al-Qaadir (The Omnipotent)");
        this.Names.add(45,"46. Al-Muqtadir (The Powerful)");
        this.Names.add(46,"47. Al-Muqaddim (The Expediter)");
        this.Names.add(47,"48. Al-Mu'akhkhir (The Delayer)");
        this.Names.add(48,"49. Al-Awwal (The First)");
        this.Names.add(49,"50. Al-Aakhir (The Last)");
        this.Names.add(50,"51. Al-Mudhil (The Humiliator)");
        this.Names.add(51,"52. As-Sami' (The All-Hearing)");
        this.Names.add(52,"53. Al-Baseer (The All-Seeing)");
        this.Names.add(53,"54. Al-Hakam (The Judge)");
        this.Names.add(54,"55. Al-'Adl (The Just, The Equitable)");
        this.Names.add(55,"56. Al-Lateef (The Most Affectionate)");
        this.Names.add(56,"57. Al-Khabeer (The All-Aware one)");
        this.Names.add(57,"58. Al-Haleem (The Forbearing)");
        this.Names.add(58,"59. Al-'Azeem (The Magnificient)");
        this.Names.add(59,"60. Al-Ghafoor (The Forgiving)");
        this.Names.add(60,"61. Ash-Shakoor (The Grateful)");
        this.Names.add(61,"62. Al-'Aliyy (The Highest)");
        this.Names.add(62,"63. Al-Kabeer (The Greatest)");
        this.Names.add(63,"64. Al-Hafeez (The Preserver)");
        this.Names.add(64,"65. Al-Muqeet (The Sustainer)");
        this.Names.add(65,"66. Al-Haseeb (The Reckoner)");
        this.Names.add(66,"67. Al-Jaleel (The Exalted)");
        this.Names.add(67,"68. Al-Kareem (The Generous)");
        this.Names.add(68,"69. Ar-Raqeeb (The Watchful)");
        this.Names.add(69,"70. Al-Mujeeb (The Responsive)");
        this.Names.add(70,"71. Al-Waasi' (The All-Encompassing)");
        this.Names.add(71,"72. Al-Hakeem (The Wise)");
        this.Names.add(72,"73. Al-Wadood (The Most Loving)");
        this.Names.add(73,"74. Al-Majeed (The Most Glorious)");
        this.Names.add(74,"75. Az-Zaahir (The Manifest)");
        this.Names.add(75,"76. Al-Baatin (The Hidden)");
        this.Names.add(76,"77. Al-Waalee (The Governer)");
        this.Names.add(77,"78. Al-Muta'aalee (The Most Exalted)");
        this.Names.add(78,"79. Al-Barr (The Source of All Goodness)");
        this.Names.add(79,"80. At-Tawwaab (The Acceptor of Repentance)");
        this.Names.add(80,"81. Al-Muntaqim (The Avenger)");
        this.Names.add(81,"82. Al-'Afuww (The Pardoner)");
        this.Names.add(82,"83. Ar-Ra'oof (The Most Kind, The Clement)");
        this.Names.add(83,"84. Maalik-ul-Mulk (The Owner of Sovereignity)");
        this.Names.add(84,"85. Dhul-Jalaali \n Wal-Ikraam (Majestic and Benevolent)");
        this.Names.add(85,"86. Al-Muqsit (The Just, The Equitable)");
        this.Names.add(86,"87. Al-Jaami' (The Gatherer)");
        this.Names.add(87,"88. Al-Ghaniyy (The Self-Sufficient)");
        this.Names.add(88,"89. Al-Mughnee (The Enricher)");
        this.Names.add(89,"90. Al-Maani' (The Preventer of Harm)");
        this.Names.add(90,"91. Ad-Daar (The Distresser)");
        this.Names.add(91,"92. An-Naafi'(The Propitious)");
        this.Names.add(92,"93. An-Noor (The Light)");
        this.Names.add(93,"94. Al-Haadee (The Guide)");
        this.Names.add(94,"95. Al-Badee' (The Originator)");
        this.Names.add(95,"96. Al-Baaqee (The Everlasting)");
        this.Names.add(96,"97. Al-Waarish (The Ultimate Inheritor");
        this.Names.add(97,"98. Ar-Rasheed (The Guide to the Right Path)");
        this.Names.add(98,"99. As-Saboor (The Patient One)");
        ...
        this.Sub_heading.add(1,"The Beneficent");
        this.Sub_heading.add(2,"The Most Merciful");
        this.Sub_heading.add(3,"The Eternal Lord");
        this.Sub_heading.add(4,"The Most Sacred");
        this.Sub_heading.add(5,"The Embodiment of Peace");
        this.Sub_heading.add(6,"The Infuser of Faith");
        this.Sub_heading.add(7,"The Preserver of Safety");
        ...
        this.Sub_heading.add(13,"The Flawless Shaper");
        this.Sub_heading.add(14,"The Great Forgiver");
        this.Sub_heading.add(15,"The All-Prevailing One");
        this.Sub_heading.add(16,"The Supreme Bestower");
        this.Sub_heading.add(17,"The Total Provider");
        this.Sub_heading.add(18,"The Supreme Solver");
        this.Sub_heading.add(19,"The All-Knowing");
        this.Sub_heading.add(20,"The Restricting One");
        this.Sub_heading.add(21,"The Expander");
        this.Sub_heading.add(22,"The Reducer");
        this.Sub_heading.add(23,"The Elevating One");
        this.Sub_heading.add(24,"The Honourer-Bestower");
        this.Sub_heading.add(25,"The Infuser of New Life");
        this.Sub_heading.add(26,"The All Observing Witness");
        this.Sub_heading.add(27,"The Embodiment of Truth");
        this.Sub_heading.add(28,"The Universal Trustee");
        this.Sub_heading.add(29,"The Strong One");
        this.Sub_heading.add(30,"The Authoritative");
        ...
        this.Sub_heading.add(56,"The All-Aware one");
        ...
        this.Sub_heading.add(76," The Protector");
        ...
        this.Sub_heading.add(80,"The Lord of Retribution");

        this.Sub_heading.add(81,"The Pardoner");
        this.Sub_heading.add(82,"The Most Kind");
        this.Sub_heading.add(83,"The Owner of Sovereignity, Owner of the Kingdom");
        this.Sub_heading.add(84,"Majestic and Benevolent");
